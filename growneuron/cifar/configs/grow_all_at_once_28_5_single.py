...
from growneuron.cifar.configs import baseline_small_28_5


def get_config():
  """Builds and returns config."""
  config = baseline_small_28_5.get_config()
